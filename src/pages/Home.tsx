...
const features = [
  {
    ...
    description: 'Get your website live in 24 hours with our rapid development process.'
  },
  {
    icon: Users,
    title: 'Dedicated Project Manager',
    description: 'Your own dedicated manager available 24/7 throughout the project.'
  },
  {
    icon: Globe,
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-white/20 text-white border-white/30">
                  🎁 Special Offer: 20% Off New Projects
                </Badge>
                ...
                <p className="text-xl text-primary-foreground/90 max-w-2xl">
                  Launch your business online with stunning, mobile-friendly websites, custom apps, and 24/7 support—all from one trusted partner.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Your growth is our responsibility. We deliver exceptional digital solutions with unmatched support.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="card-gradient shadow-elegant hover-scale">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From websites to apps, we provide everything your business needs to succeed online.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {[
              { title: 'Web Design & Development', desc: 'Custom, mobile-friendly designs with same-day publishing' },
              { title: 'App Development', desc: 'Native and cross-platform apps for iOS and Android' },
              { title: 'Digital Marketing', desc: 'SEO, PPC, and social media marketing to grow your business' },
              { title: 'Graphic Design', desc: 'Logos, branding, and marketing materials' },
              { title: 'Cloud Hosting', desc: 'Secure, scalable hosting with 24/7 monitoring' },
              { title: 'Content Writing', desc: 'SEO-optimized content that converts visitors to customers' }
            ].map((service, index) => (
      ...
      <section className="py-20 bg-gradient-hero text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            ...
            Get started today with our 24-hour delivery guarantee.
          </p>
