...
const contactInfo = [
  {
    icon: Phone,
    title: "Phone Numbers",
    details: ["+1 1800-853-3982", "+1 213-770-4312"],
...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await axios.post(
      "https://backend.webextremesinternational.com/api/v1/user/contact",
      payload
    );
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info, index) => (
              <Card
                key={index}
                className="text-center hover-scale shadow-elegant"
              >
            ...
            {[
              {
                ...
                answer:
                  "We offer same-day publishing for websites and can deliver most projects within 24-48 hours, depending on complexity.",
              },
              {
                question: "Do you provide ongoing support?",
                answer:
                  "Yes! We provide unlimited support 365/24/7 to all our clients. Your success is our responsibility.",
              },
              {
                question: "What technologies do you work with?",
                answer:
                  "We work with all modern technologies including React, Node.js, PHP, Python, WordPress, Shopify, and many more.",
              },
              {
                question: "Can you help with digital marketing?",
                answer:
                  "Absolutely! We offer comprehensive digital marketing services including SEO, PPC, social media marketing, and content strategy.",
              },
            ].map((faq, index) => (
