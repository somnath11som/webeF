...
export default function Cart() {
 ...
 const subtotal = state.total;
  ...
  const handleCheckout = async () => {
    ...
    const response = await axios.post('http://localhost:4000/api/v1/order/createOrder', payload);
                    ...
                    <div key={item.id} className="flex items-center space-x-4 p-4 border rounded-lg">
                      ...
                      <div className="text-right">
                        <div className="font-semibold">
                          ${(item.price * item.quantity).toLocaleString()}{getItemBillingInfo(item)}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          ${item.price}{getItemBillingInfo(item)} each
                        </div>
                      </div>
            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  {discount > 0 && (
                    <div className="flex items-center space-x-2 text-green-600">
                      ...
                      <span className="text-sm">{discount}% discount applied</span>
                    </div>
                  )}
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Secure checkout - We'll contact you to discuss payment options.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setCheckoutData(prev => ({ ...prev, company: e.target.value }))}
                    />
                  </div>
                  ...
                  <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                    ...
                    <span>We'll contact you within 1 hour to discuss payment options and project details.</span>
                  </div>
                </CardContent>
              </Card>
            </div>
